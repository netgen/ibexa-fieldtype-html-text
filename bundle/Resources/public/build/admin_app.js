    ...
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        if (typeof window.ibexa.BaseRichText !== 'undefined') {
          console.log("u ifu");
          CKEditor = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@ckeditor/ckeditor5-editor-inline/src/inlineeditor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        }
        ngHtmlTextEditFields = document.querySelectorAll('.ibexa-field-edit--nghtmltext');
        ngHtmlTextEditFields.forEach(function (ngHtmlTextEditField) {
          var ckEditorTextArea = ngHtmlTextEditField.querySelector('textarea');
